...
function startPractice(topic) {
  document.getElementById("testStyleArea").style.display = "none";
...
// =====================================================
function showTestStyle() {
  document.getElementById("practiceArea").style.display = "none";
  document.getElementById("testStyleArea").style.display = "block";
  startTestStyle();
}
...
function startTestStyle() {
  ...
  const p = testStyleGenerators[pick]();
...
// =====================================================
// TEST‑STYLE QUESTION BANK (100+ possible)
// =====================================================
const testStyleGenerators = {
  linear: () => {
    const a = rand(2, 9), b = rand(1, 10), c = rand(5, 25);
    return {
  ...
  sequence: () => {
    const a = rand(2, 12), d = rand(1, 8), n = rand(5, 15);
    return {
  ...
  rate: () => {
    const d = rand(50, 250), t = rand(1, 5);
    return {
  ...
  percent: () => {
    const base = rand(50, 250), p = rand(10, 50);
    return {
...
function generateProblem(topic) {
  const topics = {
    ...
    quadratics: () => testStyleGenerators.quadratic(),
    ...
    word: () => {
      const rate = rand(5, 10), hours = rand(2, 6);
      return {
